...
export class Businesses {
  ...
  // @Column('text', { name: 'facilities', nullable: true })
  ...
  @Column('varchar', { name: 'website', length: 1000, nullable: true })
  public website: string;

  @Column('varchar', { name: 'facebook_link', length: 1000, nullable: true })
  public facebookLink: string;

  @Column('varchar', { name: 'twitter_link', length: 255, nullable: true })
  public twitterLink: string;

  @Column('varchar', { name: 'instagram_link', length: 1000, nullable: true })
  public instagramLink: string;

  @Column('varchar', { name: 'youtube_link', length: 1000, nullable: true })
  public youtubeLink: string;

  @Column('varchar', { name: 'linkedin_link', length: 1000, nullable: true })
